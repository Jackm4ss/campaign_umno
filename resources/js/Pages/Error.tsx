        ...
        <>
            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
                <div className="text-center">
                    ...
                    <a href={baseUrl('/')} className="inline-flex items-center gap-2 px-6 py-3 bg-[#CC1A1A] text-white text-xs font-bold uppercase tracking-widest rounded hover:bg-[#9E1212] transition-colors">
                        Kembali ke Utama
                    </a>
                </div>
            </div>
