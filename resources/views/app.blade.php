...
<head>
    ...
    @php
        ...
        $ogTitle = $meta['title'] ?? 'Tak Banyak Alasan';
        $ogDesc = $meta['description'] ?? 'Terbukti, Terlihat & Terjamin';
        $ogImage = $meta['image'] ?? asset('assets/campaign-tak-banyak-alasan-render.png');
    @endphp
    <meta name="description" content="{{ $ogDesc }}">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Tak Banyak Alasan">
