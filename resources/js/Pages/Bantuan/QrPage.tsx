                ...
                <div className="bantuan-qr-container">
                    <div className="bantuan-qr-card">
                        <div className="bantuan-qr-header">
                            ...
                            <p className="bantuan-qr-subtitle">Imbas kod QR di atas untuk membuka borang bantuan di telefon anda. Borang ini disediakan oleh Tak Banyak Alasan untuk warga Wilayah Persekutuan Putrajaya.</p>
                        </div>
