...
final class ProgramResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Section::make('Kandungan Program')
                ->schema([
                    Forms\Components\RichEditor::make('lead')
                        ->label('Isi Kandungan')
                        ->validationAttribute('Isi Kandungan')
                        ->helperText('Tulis seperti artikel biasa. Gunakan Tajuk 2 untuk tajuk bahagian dan senarai poin jika diperlukan. Kandungan dipaparkan di bawah gambar program.')
                        ->placeholder('Tulis kandungan program di sini...')
                        ->toolbarButtons([
                            'h2',
                            'h3',
                            'bold',
